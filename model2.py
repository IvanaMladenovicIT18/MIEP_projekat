...
# Discriminator klasa sa smanjenom brzinom učenja
...
# Logging
import logging
logging.basicConfig(filename='model2log.txt', level=logging.INFO, format='%(message)s')

from datetime import datetime

log_file = 'model2log.txt'
